...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
    ...
    [0] = UNIMAP(
     ...
     ESC,       F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9, F10, F11, F12,          PSCR,SLCK,PAUS,         VOLD,VOLU,MUTE,
      NO,   1,   2,   3,   4,   5,   6,   7,   8,   9,   0,MINS, EQL,JYEN,BSPC,      INS,HOME,PGUP,    NLCK,PSLS,PAST,PMNS,
     TAB,   Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,LBRC,RBRC,       NO,      DEL, END,PGDN,      P7,  P8,  P9,PPLS,
    CAPS,   A,   S,   D,   F,   G,   H,   J,   K,   L,SCLN,  NO,     NUHS, ENT,                          P4,  P5,  P6,PCMM,
     FN0,  NO,   Z,   X,   C,   V,   B,   N,   M,COMM, DOT,SLSH,       RO, FN1,            UP,           P1,  P2,  P3,PENT,
    ...
    TRNS,TRNS,TRNS,JYEN,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,
